...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="ml-auto hidden opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked]/command-item:block group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  );
}
